...
After adjusting for Partner, Internet Service, Online Security, Device Protection, Streaming TV, Streaming Movies, Paperless Billing, Total Charges, and Payment Method, Customers with one-year contracts have a 67% lower hazard of churning compared to those with month-to-month contracts, regardless of tenure time.
...
After adjusting for Partner, Internet Service, Online Security, Device Protection, Streaming TV, Streaming Movies, Paperless Billing, Total Charges, and Payment Method, Customers with two-year contracts have a 98.4% lower hazard of churning compared to those with month-to-month contracts, regardless of tenure time.
...
After adjusting for Partner, Internet Service, Contract Online Security, Device Protection, Streaming TV, Streaming Movies, Paperless Billing, and Payment Method. For each one dollar increase in TotalCharges, the risk of churning decreases by 0.165% . While this is a significant predictor, the effect is quite small for customers with low TotalCharges or small changes in the Total Charges.

(Payment Method)

After adjusting for Partner, Internet Service, Contract Online Security, Device Protection, Streaming TV, Streaming Movies, Paperless Billing, and Total Charges, Customers using automatic credit card payments have a 0.4% lower hazard of churning compared to those using bank transfers, regardless of tenure time.

We are 95% confident that the true hazard of churning with credit card payments is between 17.1% lower and 19.7% higher than the hazard of churning with bank transfers. This has a non-significant p-value of 0.966.

After adjusting for Partner, Internet Service, Contract Online Security, Device Protection, Streaming TV, Streaming Movies, Paperless Billing, and Total Charges, Customers using electronic checks have a 52.3% higher hazard of churning compared to those using bank transfers, regardless of tenure time.
...
After adjusting for Partner, Internet Service, Contract Online Security, Device Protection, Streaming TV, Streaming Movies, Paperless Billing, and Total Charges, Customers using mailed checks have a 70.7% higher hazard of churning compared to those using bank transfers, regardless of tenure time.
