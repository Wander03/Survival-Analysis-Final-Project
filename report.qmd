...
Our Cox regression analysis further confirmed that longer contract durations significantly lower the hazard of churn, with two-year contracts reducing churn risk by nearly 98% compared to month-to-month plans. Additionally, higher total charges correlated with lower churn risk, although the effect size was relatively small. However, a critical finding was that several predictors violated the proportional hazards assumption, indicating that their impact on churn may vary over time.
